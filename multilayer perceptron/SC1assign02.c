...
int main(){
    ...
    char * commandsForGnuplot[] = {"set title \"100 epochs stopping criteria\"","set origin 0.0,0.0","set xlabel 'number of nodes in hidden layer'","set ylabel 'accuracy'", "plot 'data.temp' using 3:1 with linespoints title 'Quadratic Cost Function','data.temp' using 3:2 with linespoints lt rgb 'red' title 'Cross Entropy Cost'"};
